  ...
  const plans = [
    {
      ...
      features: [
        "صفحة هبوط واحدة احترافية",
        "استضافة فائقة السرعة ونطاق",
        "دعم فني أساسي",
        "ربط واتساب مباشر"
      ],
      highlight: false,
    ...
    },
    {
      ...
      features: [
        "موقع متعدد الصفحات (Premium)",
        "ربط واتساب وخرائط جوجل",
        "نموذج اتصال ديناميكي",
        "صيانة دورية وتحديثات",
        "أمان عالي (SSL)"
      ],
      highlight: true,
      buttonText: "الخيار الأفضل - اطلب الباقة",
    },
    {
      name: "Pro",
      price: "199",
      ...
      features: [
        "تصميم متقدم مخصص بالكامل",
        "نظام حجز مواعيد / متجر",
